...
print("You have 10 turns to guess the ship location\n")
...
ship_col = randint(0, len(board[0]))
...
while True:
	...
	if (guess_row == ship_row) and (guess_col == ship_col):
		...
		if turn > 9:
			print("Game Over")
			print("The ship was at row " + str(ship_row) + " and the column was at " + str(ship_col - 1 + 1))
			board[ship_row][ship_col] = "B"
			print_board(board)
			break
